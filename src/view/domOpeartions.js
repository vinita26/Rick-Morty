module.exports = class DomOperations {
    ...
    createCharacterCards(myArray, statusCode) {
        //debugger;
        if (statusCode == 200) {
            let item;
            ...
            for (var i = 0; i < myArray.results.length; i++) {
                ...
                var cardContent = '<div class="character-card bg-dark my-3"><div class="card-img-caption"><img class="card-img-top character-img" src=' + charImageURL + ' alt = "Card image cap"></img> <div class="char-title">' + charTitle + '</br><div class="char-title-details"><span>id: ' + charID + '</span><span> - </span><span>created  ' + charCreated + ' years ago</span></div></div><div class="card-body" > <ul class="list-group list-group-flush bg-secondary character-features"> <li class="list-group-item bg-secondary character-features-item" style="border: none;"> <strong>STATUS</strong> <div class="text-warning character-features-value">' + charStatus + '</div> </li> <li class="list-group-item bg-secondary character-features-item" style="border: none"> <strong>SPECIES</strong><span class="list-group text-warning character-features-value">' + charSpecies + '</span></li> <li class="list-group-item bg-secondary character-features-item" style="border: none"><strong>GENDER</strong><span class="list-group text-warning character-features-value">' + charGender + '</span> </li>  <li class="list-group-item bg-secondary character-features-item" style="border: none"> <strong>ORIGIN</strong> <span class="list-group text-warning character-features-value">' + charOrigin + '</li><li class="list-group-item bg-secondary character-features-item" style="border: none"> <strong>LAST LOCATION</strong> <span class="list-group text-warning character-features-value"}>' + charLastLocation + '</span> </li > </ul ></div ></div > ';
